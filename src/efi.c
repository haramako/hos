...
void efi_memory_descriptor_print(EFI_MemoryDescriptor *md, int index) {
	klog("%04d: 0x%016llx-0x%016llx 0x%016llx %8lld %2d %s", index, md->physical_start,
		 md->physical_start + md->number_of_pages * 4096 - 1, md->virtual_start, md->number_of_pages, md->attribute,
